...
<header class="main_header">
	...
	<div class="main_menu_wrapper">
        <a class="close_menu">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><g fill="#fff" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path d="M8 8L40 40"/><path d="M8 40L40 8"/></g></svg>
        </a>
        <div class="main_menu">
